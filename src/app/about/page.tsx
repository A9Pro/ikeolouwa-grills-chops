...
export default function AboutContactPage() {
  ...
  return (
    <div
      className="antialiased bg-cover bg-center text-[#000000] transition-all duration-500 pt-16"
    ...
    >
      ...
      <main className="relative min-h-screen flex items-center justify-center p-6 overflow-hidden">
        ...
        <div className="relative w-full max-w-4xl z-10 space-y-8">
          <div className="card p-8 sm:p-12 text-center">
            <h1 className="text-4xl sm:text-5xl font-cormorant font-bold text-[#1A1A1A] mb-4 drop-shadow-md">
              About Us
            </h1>
            <p className="text-lg font-lora text-[#000000] max-w-prose mx-auto mb-6">
            ...
            <p className="text-lg font-lora text-[#000000] max-w-prose mx-auto">
              Asese, Maba, Mowe, Olowotedo, Ascon, Magboro, Ibafo, Arepo
            </p>
          </div>

          <div className="card p-8 sm:p-12">
            <h1 className="text-4xl sm:text-5xl font-cormorant font-bold text-[#1A1A1A] mb-4 drop-shadow-md text-center">
              Contact Us
            </h1>
            <p className="text-lg font-lora text-[#000000] max-w-prose mx-auto mb-8 italic text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <form onSubmit={handleFormSubmit} className="space-y-6">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-sm font-semibold text-[#000000]"
                    >
                      Full Name
                    </label>
                    <input
              ...
              <div className="text-center md:text-left space-y-4 pt-8 md:pt-0">
                ...
                <div className="p-4 bg-[#D4A017]/10 rounded-lg border border-[#D4A017]">
                  <h3 className="text-lg font-bold text-[#1A1A1A] mb-2">☎️ Phone</h3>
                  <p className="text-sm text-[#000000]">+234 701 931 4146</p>
                </div>
                <div className="p-4 bg-[#D4A017]/10 rounded-lg border border-[#D4A017]">
                  <h3 className="text-lg font-bold text-[#1A1A1A] mb-2">
                    <Image
                  ...
                  <a
                    ...
                    className="text-sm text-[#000000] hover:text-green-600"
                  >
                    Chat with us
                  </a>
                </div>
                <div className="p-4 bg-[#D4A017]/10 rounded-lg border border-[#D4A017]">
                  <h3 className="text-lg font-bold text-[#1A1A1A] mb-2">✉️ Email</h3>
                  <p className="text-sm text-[#000000]">
      ...
      <footer className="bg-[#F8F4E3] py-12 relative border-t border-t-[#D4A017]/30">
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          <p className="text-[#000000] font-cormorant mb-4">
      ...
      {messageBoxVisible && (
        <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#F8F4E3] text-[#000000] px-8 py-6 rounded-2xl shadow-xl transition-all duration-300 opacity-100 scale-100 z-50 border border-[#D4A017]">
